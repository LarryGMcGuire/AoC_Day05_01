    ...
    public static void main(String[] args) throws IOException, FileNotFoundException {
        ...
        while ((sections = input.readLine()) != null) {
            ...
            if (!stillInStacks) {
                ...
                System.out.println("Pre Stack 4: " + stacks[3]);
                System.out.println("Pre Stack 5: " + stacks[4]);
                System.out.println("Pre Stack 6: " + stacks[5]);
                System.out.println("Pre Stack 7: " + stacks[6]);
                System.out.println("Pre Stack 8: " + stacks[7]);
                System.out.println("Pre Stack 9: " + stacks[8]);
                //  Start moving stuff
                for (int i = 0; i < moveHowMany ;  i++) {
                    // Remove from stack
                    char crate = stacks[moveFrom - 1].charAt(i);
                    // Put it in the new stack
                    stacks[moveTo - 1] = crate + stacks[moveTo - 1];
                    //System.out.println("Crate " + crate + " moved to " + moveTo  + "   Stack: " + stacks[moveTo -1] );


                }
                System.out.println("New Stack= " + stacks[moveFrom - 1].substring(moveHowMany));
